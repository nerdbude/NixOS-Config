  ...
  services.xserver = {
    windowManager.xmonad = {
      ...
      config = ''
        ...
        --    xmproc0 <- spawnPipe "xmobar -x 0 ~/home/null/.xmobarrc"
        --    xmproc1 <- spawnPipe "xmobar -x 1 ~/home/null/.xmobarrc"
        ...
        dynamicKeys modeRef = 
            ...
            , ((mod4Mask, xK_d), modeDispatch modeRef
                ...
                -- , (SessionMode, COMMAND)
                , (LaunchMode, shellPrompt myXPConfig )
                ])
            ...
            , ((mod4Mask, xK_1), modeDispatch modeRef
                [ (Normal, windows $ W.view "0")
                , (MoveMode, windows $ W.shift "0")
                , (LaunchMode, windows $ W.view "0")
                ])

            , ((mod4Mask, xK_2), modeDispatch modeRef
                [ (Normal, windows $ W.view "1")
                , (MoveMode, windows $ W.shift "1")
                , (LaunchMode, windows $ W.view "1")
                ])

            , ((mod4Mask, xK_3), modeDispatch modeRef
                [ (Normal, windows $ W.view "2")
                , (MoveMode, windows $ W.shift "2")
                , (LaunchMode, windows $ W.view "2")
                ])

            , ((mod4Mask, xK_4), modeDispatch modeRef
                [ (Normal, windows $ W.view "3")
                , (MoveMode, windows $ W.shift "3")
                , (LaunchMode, windows $ W.view "3")
                ])

            , ((mod4Mask, xK_5), modeDispatch modeRef
                [ (Normal, windows $ W.view "4")
                , (MoveMode, windows $ W.shift "4")
                , (LaunchMode, windows $ W.view "4")
                ])

            , ((mod4Mask, xK_6), modeDispatch modeRef
                [ (Normal, windows $ W.view "5")
                , (MoveMode, windows $ W.shift "5")
                , (LaunchMode, windows $ W.view "5")
                ])
        
            , ((mod4Mask, xK_7), modeDispatch modeRef
                [ (Normal, windows $ W.view "6")
                , (MoveMode, windows $ W.shift "6")
                , (LaunchMode, windows $ W.view "6")
                ])
        
            , ((mod4Mask, xK_8), modeDispatch modeRef
                [ (Normal, windows $ W.view "7")
                , (MoveMode, windows $ W.shift "7")
                , (LaunchMode, windows $ W.view "7")
                ])
        
            , ((mod4Mask, xK_9), modeDispatch modeRef
                [ (Normal, windows $ W.view "8")
                , (MoveMode, windows $ W.shift "8")
                , (LaunchMode, windows $ W.view "8")
                ])
            ]
        ...
        myXmobarPP xmproc modeRef = def {
            ...
            ppTitle              = xmobarColor "#BD93F9" "" . shorten 60,
            ppSep                = " ",
            ppLayout             = xmobarColor "#ff79c6" "",
        --            ppOrder              = \(ws:l:t:extras) -> extras ++ [ws, t],
            ppOrder              = \(ws:_layout:t:extras) ->
                let [mode, winCount, kernelTime] =
                      take 3 (extras ++ repeat "")
                in [ mode
                   , ws ++ winCount
                   , t
                   , kernelTime
        ...
        myXPConfig :: XPConfig
        myXPConfig = def
          { font = "xft:Berkeley Mono Nerd Font:pixelsize=11"
          , bgColor             = "#44475A"
          , fgColor             = "#FF79C6"
          , bgHLight            = "#FF79C6"
          , fgHLight            = "#44475A"
